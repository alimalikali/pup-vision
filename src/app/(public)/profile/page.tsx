  ...
  return (
      <div className="min-h-screen bg-background">
        ...
        <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          {isEditing ? (
            <ProfileEditForm profile={profile} onSave={handleSaveProfile} />
          ) : (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2 text-sm">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge variant={profile.avatar ? "secondary" : "outline"}>
                            {profile.avatar ? "Done" : "Pending"}
                          </Badge>
                        </div>
                        <div className="flex items-center justify-between">
                          <span>Complete bio</span>
                          <Badge variant={profile.purposeNarrative && profile.purposeNarrative.length > 50 ? "secondary" : "outline"}>
                            {profile.purposeNarrative && profile.purposeNarrative.length > 50 ? "Done" : "Pending"}
                          </Badge>
                        </div>
                        <div className="flex items-center justify-between">
                          <span>Add interests</span>
                          <Badge variant={profile.interests && profile.interests.length > 0 ? "secondary" : "outline"}>
                            {profile.interests && profile.interests.length > 0 ? "Done" : "Pending"}
                          </Badge>
                        </div>
                      </div>
                    </div>
