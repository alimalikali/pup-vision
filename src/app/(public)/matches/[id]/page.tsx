...
export default function MatchDetailPage() {
  ...
  const compatibilityBreakdown = [
    { category: "Purpose Alignment", score: profile.compatibilityScore || 0, description: "Shared values and life direction" },
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Your shared focus on {profile.purposeDomain.toLowerCase()} and{" "}
                        {profile.purposeModality.toLowerCase()} approach creates strong compatibility for long-term
                        partnership.
                      </p>
                    </div>
                  </CardContent>
