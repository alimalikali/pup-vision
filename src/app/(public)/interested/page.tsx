        ...
        <div className="flex items-center justify-center min-h-[50vh]">
          <div className="text-center">
            <p className="text-muted-foreground">
              Please log in to view who&apos;s interested.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">
                {admirers.length > 0
                  ? Math.round((matches.length / admirers.length) * 100)
                  : 0}
                %
              </div>
        ...
        <Tabs defaultValue="admirers" className="space-y-6">
          <TabsList>
            <TabsTrigger value="admirers">
              Who Likes You ({admirers.length})
            </TabsTrigger>
            <TabsTrigger value="admired">
              You Admire ({admired.length})
            </TabsTrigger>
              ...
              <Card className="text-center py-12">
                <CardContent>
                  ...
                  <h3 className="text-lg font-semibold mb-2">
                    No one has admired you yet
                  </h3>
                  <p className="text-muted-foreground mb-4">
                    Keep improving your profile and browsing matches to get more
                    visibility.
                  </p>
                  <Button asChild>
            ...
            {admired.length === 0 && (
              <Card className="text-center py-12">
                <CardContent>
                  ...
                  <h3 className="text-lg font-semibold mb-2">
                    You haven&apos;t admired anyone yet
                  </h3>
                  <p className="text-muted-foreground mb-4">
                    Start browsing matches to find people you&apos;re interested
                    in.
                  </p>
                  <Button asChild>
                    <Link href="/matches">Browse Matches</Link>
            ...
            {matches.length === 0 && (
              <Card className="text-center py-12">
                <CardContent>
                  ...
                  <p className="text-muted-foreground mb-4">
                    When someone you admire also admires you back, you&apos;ll
                    have a match!
                  </p>
                  <Button asChild>
                    <Link href="/matches">Browse Matches</Link>
