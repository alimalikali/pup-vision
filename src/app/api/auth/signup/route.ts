...
export async function POST(request: NextRequest) {
  try {
      ...
      data: {
        ...
        profile: {
          create: {
            ...
            purposeDomain: 'PERSONAL', // Default value
            purposeArchetype: 'EXPLORER', // Default value
            purposeModality: 'INDIVIDUAL', // Default value
            personality: 'AMBIVERT', // Default value
            maritalStatus: 'SINGLE', // Default value
            lookingFor: 'SINGLE', // Default value
            language: 'ENGLISH', // Default value
            smoke: 'NO', // Default value
            alcohol: 'NO', // Default value
            drugs: 'NO', // Default value
    ...
    console.log('[Signup API] Generated tokens for user:', user.email);
