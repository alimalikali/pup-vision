        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) => handleInputChange("dob", e.target.value ? new Date(e.target.value) : null)}
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) => handleInputChange("purposeNarrative", e.target.value)}
              rows={4}
              ...
              {getEnumValues(Interest).map((interest) => (
                <div key={interest} className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={() => handleInterestToggle(interest as Interest)}
                  />
              ...
              {getEnumValues(Politics).map((politics) => (
                <div key={politics} className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={() => handlePoliticsToggle(politics as Politics)}
                  />
