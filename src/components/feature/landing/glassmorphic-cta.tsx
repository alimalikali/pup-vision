      ...
      <motion.div className="container mx-auto px-4" style={{ opacity, y, scale }}>
        ...
        >
          <div className="text-center">
            <SectionHeading title="Ready to Find Your Purpose Partner?" description="Join thousands of purpose-driven individuals who have found meaningful connections through Pup." className="mb-8" titleClassName="text-3xl md:text-5xl" descriptionClassName="text-xl" />

            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="inline-block">
              <Button asChild size="lg" className="text-lg px-8 rounded-full h-14 bg-gradient-to-r from-primary to-secondary hover:from-primary/90 hover:to-secondary/90 shadow-lg">
                <Link href="/signup">
                  Start Your Journey
