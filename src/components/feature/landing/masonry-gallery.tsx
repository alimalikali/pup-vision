...
export function MasonryGallery() {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900" ref={ref}>
      <motion.div className="container mx-auto px-4" style={{ opacity, y }}>
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-pink-500/10 to-purple-500/10 border border-pink-200/20 dark:border-pink-500/20 mb-6">
            ...
            <span className="text-sm font-medium text-pink-600 dark:text-pink-400">Success Stories</span>
          </div>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="p-6 rounded-2xl bg-gradient-to-br from-pink-500/10 to-purple-500/10 border border-pink-200/20 dark:border-pink-500/20">
              <div className="text-3xl font-bold text-pink-600 dark:text-pink-400 mb-2">500+</div>
              <div className="text-slate-600 dark:text-slate-300">Couples Matched</div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-emerald-500/10 to-teal-500/10 border border-emerald-200/20 dark:border-emerald-500/20">
              ...
              <div className="text-slate-600 dark:text-slate-300">Cities Worldwide</div>
            </div>
          </div>
        </motion.div>
      </motion.div>
            ...
            <div className="relative bg-white dark:bg-slate-800 rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="p-8 bg-gradient-to-br from-slate-50 to-white dark:from-slate-800 dark:to-slate-900">
                ...
                <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                  This couple found each other through our platform and have been making a positive impact in their community together. Their story represents the power of purpose-driven relationships.
                </p>
              </div>
            </div>
          </motion.div>
