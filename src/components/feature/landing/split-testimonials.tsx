...
const testimonials = [
  {
    quote: "Finding someone who shares my passion for educational reform has been life-changing. We're now working on projects together that neither of us could accomplish alone.",
    name: 'Sarah Ahmed',
  ...
  {
    quote: "I was tired of dating apps that focus on superficial traits. Pup connected me with someone who shares my spiritual journey and life goals. It's been transformative.",
    name: 'Omar Farooq',
  ...
  {
    quote: 'As an environmental activist, finding a partner who shares my passion was crucial. Thanks to Pup, I found my perfect match who complements my work and vision.',
    name: 'Layla Mahmoud',
  ...
  {
    quote: "The purpose-first approach helped me find someone who truly understands my mission to improve healthcare in underserved communities. We're now life partners in every sense.",
    name: 'Yusuf Ibrahim',
  ...
  return (
    <section ref={ref}>
      <motion.div className="container mx-auto px-4" style={{ opacity, y }}>
        <SectionHeading title="Voices of Purpose" description="Hear from couples who found each other through shared purpose and values." className="mb-16" />
            ...
            >
              <div className="w-full md:w-1/3 flex justify-center">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-2 -right-2 bg-primary text-primary-foreground text-xs rounded-full px-3 py-1 font-medium">{testimonial.location}</div>
                </div>
              </div>

              <Card className={`w-full md:w-2/3 border-none shadow-lg ${index % 2 === 0 ? 'md:rounded-l-3xl' : 'md:rounded-r-3xl'}`}>
