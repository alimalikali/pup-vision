        ...
        >
          <motion.div className="lg:col-span-2" variants={itemVariants}>
            ...
            <p className="text-muted-foreground mb-8 max-w-md">
              Pup is a purpose-first marriage bureau that connects people based
              on shared values, life missions, and compatible goals. We believe
              that relationships built on aligned purpose create the strongest
              foundation.
            </p>
